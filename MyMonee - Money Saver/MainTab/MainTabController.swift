...
class MainTabController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        homeTab.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor(red: 0.314,
                    green: 0.412,
                    blue: 0.722,
                    alpha: 1)],
                    for: .selected)
        homeTab.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor(red: 0.51,
                    green: 0.51,
                    blue: 0.51,
                    alpha: 1)],
                    for: .normal)
        ...
        dreamTab.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor(red: 0.314,
                    green: 0.412,
                    blue: 0.722,
                    alpha: 1)],
                    for: .selected)
        dreamTab.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor(red: 0.51,
                    green: 0.51,
                    blue: 0.51,
                    alpha: 1)],
                    for: .normal)
        ...
        profileTab.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor(red: 0.314,
                    green: 0.412,
                    blue: 0.722,
                    alpha: 1)],
                    for: .selected)
        profileTab.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor(red: 0.51,
                    green: 0.51,
                    blue: 0.51,
                    alpha: 1)],
                    for: .normal)
